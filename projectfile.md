...
### Пример
Например, необходимо зашифровать сообщение "THE BUS IS LATE" (автобус опаздывает). Пусть ключом будет слово "tulip" (тульпан). Тогда, по таблице, первая буква шифртекста будет M. По аналогии, зашифруем все остальные буквы.
